...
struct TickersRouteTests: RouteTestable {
    ...
    @Test func create_serviceError_returnsError() async throws {
        let mockService = MockTickersService()
        mockService.createResult = .failure(Abort(.internalServerError))
    ...
    @Test func search_serviceError_returnsError() async throws {
        let mockService = MockTickersService()
        mockService.searchResult = .failure(Abort(.internalServerError))
